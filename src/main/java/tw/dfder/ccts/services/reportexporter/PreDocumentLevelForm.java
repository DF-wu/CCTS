...
public class PreDocumentLevelForm implements ReportExportEngine{
    ...
    public String exportReport(CCTSTest cctsTest) {
        ...
        if(cctsTest.isDuplicatedTitle()) {
            msg += "+ Duplicated title occurred. Please correct CCTS Document." + System.lineSeparator();
        }

        for (CCTSDocumentError error : cctsTest.getDocumentErrors()) {
            msg += "### CCTS Document File Name: " + error.getDocument_file_name() + System.lineSeparator();
            msg += "    + Error Message: " + error.getStatusCode().getMessage() + System.lineSeparator();
            msg += "    " + error.getError() + System.lineSeparator();
            msg += error.getError() + System.lineSeparator();
        }
